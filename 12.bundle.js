(window.webpackJsonp=window.webpackJsonp||[]).push([[12],{132:function(e,t,a){var s={"./dnd-character-builder-attributes":[115,4],"./dnd-character-builder-attributes.js":[115,4],"./dnd-character-builder-background-race":[112,7],"./dnd-character-builder-background-race.js":[112,7],"./dnd-character-builder-class":[116,9,3],"./dnd-character-builder-class.js":[116,9,3],"./dnd-character-builder-equipment":[113,5],"./dnd-character-builder-equipment.js":[113,5],"./dnd-character-builder-spells":[114,8],"./dnd-character-builder-spells.js":[114,8]};function r(e){if(!a.o(s,e))return Promise.resolve().then((function(){var t=new Error("Cannot find module '"+e+"'");throw t.code="MODULE_NOT_FOUND",t}));var t=s[e],r=t[0];return Promise.all(t.slice(1).map(a.e)).then((function(){return a(r)}))}r.keys=function(){return Object.keys(s)},r.id=132,e.exports=r},98:function(e,t,a){"use strict";a.r(t);var s=a(7),r=(a(62),a(69),a(136));a(73),a(74);class c extends s.a{static get properties(){return{tabs:{type:Array,observer:"tabsChanged"},initialSelectedIndex:{type:Number,value:0}}}tabsChanged(){this.tabs.length&&setTimeout(()=>{this.tabBar=new r.a(this.$.tabs),this.$.tabs.addEventListener("MDCTabBar:activated",e=>{this.handleTabChange(e.detail.index)}),this.tabBar.activateTab(this.initialSelectedIndex)},0)}handleTabChange(e){this.dispatchEvent(new CustomEvent("tabChange",{bubbles:!0,composed:!0,detail:{index:e}}))}static get template(){return s.b`
