(window.webpackJsonp=window.webpackJsonp||[]).push([[11],{42:function(e,t,l){"use strict";l.r(t);var s=l(12),a=(l(21),l(22),l(25),l(60),l(53)),d=l(54),c=l(59),i=l(11);class n extends s.a{static get properties(){return{classes:{type:Object,observer:"_dataLoaded"},hash:{type:String,value:""},itemOpened:{value:!1},loading:{type:Boolean,value:!0,observer:"_loadingChange"}}}static get observers(){return["_updateClassFromHash(classes, hash)"]}constructor(){super(),this.loading=!0,Object(a.a)("classes").then(e=>{this.set("classes",e),this.loading=!1})}connectedCallback(){super.connectedCallback(),this.selectionChangeEventHandler=e=>{let t=e?e.detail.selection:Object(i.c)();t&&this.set("hash",t)},this.deselectionChangeEventHandler=()=>{this.set("hash","")},this.selectionChangeEventHandler(),Object(i.e)().addEventListener("selection-change",this.selectionChangeEventHandler),Object(i.e)().addEventListener("selection-deselected",this.deselectionChangeEventHandler),Object(c.onLoad)(this.shadowRoot)}disconnectedCallback(){super.disconnectedCallback(),this.deselectionChangeEventHandler(),Object(i.e)().removeEventListener("selection-change",this.selectionChangeEventHandler),Object(i.e)().removeEventListener("selection-deselected",this.deselectionChangeEventHandler)}_loadingChange(){this.dispatchEvent(new CustomEvent("loading-data",{bubbles:!0,composed:!0,detail:{loading:this.loading}}))}_dataLoaded(){Object(c.onDataLoad)(this.classes,this.shadowRoot)}_updateClassFromHash(){if(this.classes&&this.hash){let e,t;if(this.hash.indexOf(",")>-1){let l=this.hash.split(",");e=Object(d.b)(this.classes,l[0]),t=l.slice(1)}else e=Object(d.b)(this.classes,this.hash);if(e){this.itemOpened=!0;let l=e!==this.prevClass;this.prevClass=e,l&&Object(c.onHashChange)(e,this.shadowRoot),t&&Object(c.onSubChange)(t,this.hash,this.shadowRoot),this.dispatchEvent(new CustomEvent("title-change",{bubbles:!0,composed:!0,detail:{title:e.name}})),l&&window.scrollTo(0,0)}else Object(i.a)(!0)}this.hash||(this.itemOpened=!1)}_clearSelectionHandler(){Object(i.a)(!0)}_mainClass(){return this.itemOpened?"main item-opened":"main"}static get template(){return s.b`
