(window.webpackJsonp=window.webpackJsonp||[]).push([[10],{47:function(e,t,l){"use strict";l.r(t);var s=l(11),a=(l(26),l(27),l(30),l(65),l(57)),d=l(59),c=l(66),i=l(13),o=l(64),r=l(3);class n extends s.a{static get properties(){return{classes:{type:Object,observer:"_dataLoaded"},hash:{type:String,value:""},itemOpened:{value:!1},loading:{type:Boolean,value:!0,observer:"_loadingChange"}}}static get observers(){return["_updateClassFromHash(classes, hash)"]}constructor(){super(),this.loading=!0,Object(a.a)("classes").then(e=>{this.set("classes",e),this.loading=!1})}connectedCallback(){super.connectedCallback(),this.populateHandlers(),Object(i.e)().addEventListener("selection-change",this.selectionChangeEventHandler),Object(i.e)().addEventListener("selection-deselected",this.deselectionChangeEventHandler),this.$.backToTop.addEventListener("click",this.backToTopEventHandler),window.addEventListener("scroll",this.scrollEventHandler)}disconnectedCallback(){super.disconnectedCallback(),this.deselectionChangeEventHandler(),Object(i.e)().removeEventListener("selection-change",this.selectionChangeEventHandler),Object(i.e)().removeEventListener("selection-deselected",this.deselectionChangeEventHandler),this.$.backToTop.removeEventListener("click",this.backToTopEventHandler),window.removeEventListener("scroll",this.scrollEventHandler)}populateHandlers(){this.selectionChangeEventHandler=e=>{let t=e?e.detail.selection:Object(i.c)();t&&this.set("hash",t)},this.selectionChangeEventHandler(),this.deselectionChangeEventHandler=()=>{this.set("hash","")},this.backToTopEventHandler=()=>{Object(o.a)(400)},this.scrollEventHandler=Object(r.throttle)(()=>{window.scrollY>850?this.$.backToTop.classList.remove("hidden"):this.$.backToTop.classList.add("hidden"),Object(r.jqOffset)(this.shadowRoot.querySelector("#subclassHeight")).top-document.body.scrollTop<34?this.shadowRoot.querySelector("#subclasses").classList.contains("fixed")||(this.shadowRoot.querySelector("#subclasses").classList.add("fixed"),this.shadowRoot.querySelector("#subclassHeight").style.height=Object(r.jqHeight)(this.shadowRoot.querySelector("#subclasses"))+40+"px"):(this.shadowRoot.querySelector("#subclasses").classList.remove("fixed"),this.shadowRoot.querySelector("#subclassHeight").style.height="0")},100)}_loadingChange(){this.dispatchEvent(new CustomEvent("loading-data",{bubbles:!0,composed:!0,detail:{loading:this.loading}}))}_dataLoaded(){Object(c.onDataLoad)(this.classes,this.shadowRoot)}_updateClassFromHash(){if(this.classes&&this.hash){let e,t;if(this.hash.indexOf(",")>-1){let l=this.hash.split(",");e=Object(d.b)(this.classes,l[0]),t=l.slice(1)}else e=Object(d.b)(this.classes,this.hash);if(e){this.itemOpened=!0;let l=e!==this.prevClass;this.prevClass=e,l&&(window.scrollTo(0,0),Object(c.onClassChange)(e,this.shadowRoot)),t&&Object(c.onSubChange)(t,this.hash,this.shadowRoot),this.dispatchEvent(new CustomEvent("title-change",{bubbles:!0,composed:!0,detail:{title:e.name}}))}else Object(i.a)(!0)}this.hash||(this.itemOpened=!1)}_clearSelectionHandler(){Object(i.a)(!0)}_mainClass(){return this.itemOpened?"main item-opened":"main"}static get template(){return s.b`
    ...
    `}}customElements.define("dnd-classes",n);class b extends s.a{static get template(){return s.b`
      <style include="material-styles my-styles"></style>
