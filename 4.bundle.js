...
This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
*/
const c=document.createElement("template");c.innerHTML='<dom-module id="vaadin-integer-field-template">\n\n  \n</dom-module>',document.head.appendChild(c.content);class h extends o{static get is(){return"vaadin-integer-field"}static get version(){return"2.6.2"}static get properties(){return{pattern:String,preventInvalidInput:Boolean,minlength:Number,maxlength:Number}}ready(){super.ready(),this._enabledCharPattern="[-+\\d]"}_valueChanged(t,e){if(""!==t&&!this.__isInteger(t))return console.warn(`Trying to set non-integer value "${t}" to <vaadin-integer-field>. Clearing the value.`),void(this.value="");super._valueChanged(t,e)}_stepChanged(t,e){if(!this.__hasOnlyDigits(t))return console.warn(`Trying to set invalid step size "${t}", which is not a positive integer, to <vaadin-integer-field>. Resetting the default value 1.`),void(this.step=1);super._stepChanged(t,e)}__isInteger(t){return/^(-\d)?\d*$/.test(String(t))}__hasOnlyDigits(t){return/^\d*$/.test(String(t))}}window.customElements.define(h.is,h);i(107);var u=i(18),p=i(2);class v extends a.a{static get properties(){return{str:{type:Number},dex:{type:Number},con:{type:Number},int:{type:Number},wis:{type:Number},cha:{type:Number},strAdj:{type:Number,value:0},dexAdj:{type:Number,value:0},conAdj:{type:Number,value:0},intAdj:{type:Number,value:0},wisAdj:{type:Number,value:0},chaAdj:{type:Number,value:0},saves:{type:Array,value:[]},classSkillProfOptions:{type:Object,value:{}},backgroundSkillProfOptions:{type:Object,value:[]},defaultBackgroundSkillProf:{type:String,value:""},raceAttributeOptions:{type:Object,value:[]},defaultRaceAttribute:{type:String,value:""},strProfs:{type:String,value:""},dexProfs:{type:String,value:""},intProfs:{type:String,value:""},wisProfs:{type:String,value:""},chaProfs:{type:String,value:""}}}static get observers(){return["updateCharAttr(str, dex, con, int, wis, cha)"]}updateCharAttr(t,e,i,a,s,n){t&&e&&i&&a&&s&&n&&Object(u.D)({str:t,dex:e,con:i,int:a,wis:s,cha:n})}connectedCallback(){super.connectedCallback(),this.characterChangeHandler=t=>{let e=t.detail.character;this.updateAttributesFromCharacter(e)},this.updateAttributesFromCharacter(Object(u.p)()),Object(u.g)().addEventListener("character-selected",this.characterChangeHandler)}disconnectedCallback(){super.disconnectedCallback(),Object(u.g)().removeEventListener("character-selected",this.characterChangeHandler)}async updateAttributesFromCharacter(t){if(t&&t.attr){const e=t.attr;e.str===this.str&&e.dex===this.dex&&e.con===this.con&&e.int===this.int&&e.wis===this.wis&&e.cha===this.cha||this.setProperties({str:t.attr.str,dex:t.attr.dex,con:t.attr.con,int:t.attr.int,wis:t.attr.wis,cha:t.attr.cha}),this.saves=await Object(u.i)(),this.classSkillProfOptions=await Object(u.j)(),this.classSkillProfSelections=t.classSkillProficiencies;let i=await Object(u.f)();i&&i.choose?(this.backgroundSkillProfOptions=i.choose.from,this.backgroundSkillProfChoices=i.choose.count||1,this.backgroundSkillProfSelections=t.backgroundSkillProficiencies):(this.backgroundSkillProfOptions=void 0,this.backgroundSkillProfChoices=void 0,this.backgroundSkillProfSelections=void 0);let a=await Object(u.e)(i);this.defaultBackgroundSkillProf=a.map(t=>Object(p.util_capitalizeAll)(t)).join(", ");let s={str:0,dex:0,con:0,int:0,wis:0,cha:0},n=await Object(u.o)();n&&n.choose?(this.raceAttributeOptions=n.choose.from.map(t=>t.toUpperCase()),this.raceAttributeChoices=n.choose.count||1,this.raceAttributeSelections=t.raceAttributes,t.raceAttributes.forEach(t=>{s[t.toLowerCase()]++})):(this.raceAttributeOptions=void 0,this.raceAttributeChoices=void 0,this.raceAttributeSelections=void 0);let l=await Object(u.n)(n);this.defaultRaceAttribute=l.map(t=>{let e=t[0].toLowerCase(),i=t[1];return s[e]+=i,e.toUpperCase()+" "+this._absInt(i)}).join(", ");let d=await Object(u.c)();for(let t of d)t.featSelections&&(s[t.featSelections.toLowerCase()]+=1),t.featAttribute&&Object.entries(t.featAttribute).filter(t=>"choose"!==t[0]).forEach(t=>{let e=t[0].toLowerCase(),i=t[1];s[e]+=i}),t.asiAttributes&&Object.entries(t.asiAttributes).forEach(t=>{let e=t[0].toLowerCase(),i=t[1];s[e]+=i});this.strAdj=s.str,this.dexAdj=s.dex,this.conAdj=s.con,this.intAdj=s.int,this.wisAdj=s.wis,this.chaAdj=s.cha;let r=await Object(u.q)("str");this.strProfs=r.map(t=>Object(p.util_capitalizeAll)(t)).join(", ");let o=await Object(u.q)("dex");this.dexProfs=o.map(t=>Object(p.util_capitalizeAll)(t)).join(", ");let c=await Object(u.q)("int");this.intProfs=c.map(t=>Object(p.util_capitalizeAll)(t)).join(", ");let h=await Object(u.q)("wis");this.wisProfs=h.map(t=>Object(p.util_capitalizeAll)(t)).join(", ");let v=await Object(u.q)("cha");this.chaProfs=v.map(t=>Object(p.util_capitalizeAll)(t)).join(", ")}}_adjustString(t){return 0!==t&&void 0!==t?this._absInt(t):""}_total(t,e){let i=parseInt(t),a=parseInt(e);return i=isNaN(i)?0:i,a=isNaN(a)?0:a,i+a}_mod(t,e){return this._absInt(Math.floor((this._total(t,e)-10)/2))}_absInt(t){return t>0?"+"+t:t}_contains(t,e){return t.indexOf(e)>-1}_exists(){for(let t of arguments)if(t&&(t.constructor!==Object||Object.entries(t).length>0)&&(!Array.isArray(t)||t.length>0))return!0;return!1}_classSkillAddCallback(t){Object(u.A)(t)}_backgroundSkillAddCallback(t){Object(u.y)(t)}_raceAttributeAddCallback(t){Object(u.C)(t)}static get template(){return a.b`
